...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //RunApp(inventoryHandler, productCategory, product);
        ...
        //private static void RunApp(IInventoryHandler inventoryHandler, ProductCategoryModel productCategory, ProductModel product)
        //{
